    ...
    <nav className="w-full px-4 sm:px-8 py-3 flex items-center justify-between z-20 relative">
      ...
      <div className="hidden md:flex w-full items-center justify-between">
        ...
        <div className="flex items-center gap-4 flex-shrink-0">
          ...
          {/* Save Job Button */}
          <Link href="/home/freelancers/saved-jobs">
            <button className="p-2 mb-1 bg-indigo-600 text-white rounded-full font-semibold cursor-pointer shadow hover:bg-indigo-700 transition">
              <FaHeart />
            </button>
          </Link>
      ...
      <div className="flex md:hidden w-full items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="relative">
            <Link href="/home/freelancers/profile">
              <img
                src="/avatar-placeholder.png"
                alt="User Avatar"
                className="h-9 w-9 rounded-full border border-indigo-200 object-cover"
